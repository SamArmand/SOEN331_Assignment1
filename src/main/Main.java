...
public class Main {
	...
	public static void main(String[] args) {
		...
		Vertex w = new Vertex();
		Vertex u = new Vertex();
		Element<String> x = new Element<String>("x"); //Element
		Element<String> y = new Element<String>("y");
		...
		//Graph Axiom 8
		System.out.println("Graph Axiom 8: " + (new Graph<Element<String>>().insertEdge(v, w, x).removeEdge(v, w).countAllEdges() == 0));
		
		//Graph Axiom 9
		g = new Graph<Element<String>>().insertEdge(v, w, x);
		try {
		...
		//Graph Axiom 10
		g = new Graph<Element<String>>().insertEdge(v, w, x).insertEdge(w, u, y);
		ArrayList<Edge<Element<String>>> incidentEdges = g.incidentEdges(w);
		
		ArrayList<Edge<Element<String>>> testIncidentEdges = new ArrayList<Edge<Element<String>>>();
		try {
		...
		//Graph Axiom 12
		g = new Graph<Element<String>>().insertEdge(v, w, x);
		ArrayList<Vertex> testEndVertices = new ArrayList<Vertex>();
		...
		g = new Graph<Element<String>>().insertEdge(v, w, x);
		try {
			System.out.println("Graph Axiom 13: " + (g.getEdgeElem(g.getEdge(v, w)) == x));
		}
		catch (Exception e) {
		...
		g = new Graph<Element<String>>().insertEdge(v, w, x);
		try {
			System.out.println("Graph Axiom 14: " + (g.replaceEdgeElem(g.getEdge(v, w), y).getEdgeElem(g.getEdge(v, w)) == y));
		}
		catch (Exception e) {
		...
		d = new DirectedGraph<Element<String>>().insertDirectedEdge(v, w, x).insertDirectedEdge(w, v, y);
		ArrayList<Edge<Element<String>>> testIncomingEdges = new ArrayList<Edge<Element<String>>>();
		try {
		...
		System.out.println("Directed Graph Axiom 6: " + (new DirectedGraph<Element<String>>().insertDirectedEdge(v, w, x).insertDirectedEdge(w, v, y).inDegreeOf(v) == 1));
		
		//Directed Graph Axiom 7
		System.out.println("Directed Graph Axiom 7: " + (new DirectedGraph<Element<String>>().insertDirectedEdge(v, w, x).insertDirectedEdge(w, v, y).outDegreeOf(v) == 1));
		
		//Directed Graph Axiom 8
		d = new DirectedGraph<Element<String>>().insertDirectedEdge(v, w, x).insertDirectedEdge(w, v, y);
		ArrayList<Edge<Element<String>>> testOutgoingEdges = new ArrayList<Edge<Element<String>>>();
		try {
		...
		System.out.println("Directed Graph Axiom 9: " + (new DirectedGraph<Element<String>>().insertDirectedEdge(v, w, x).insertDirectedEdge(u, w, y).inDegreeOf(w) == 2));
	
		//Directed Graph Axiom 10
		System.out.println("Directed Graph Axiom 10: " + (new DirectedGraph<Element<String>>().insertDirectedEdge(v, w, x).insertDirectedEdge(u, w, y).outDegreeOf(v) == 1));
